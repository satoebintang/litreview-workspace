...
export default async function DeduplicationPairPage({ params, searchParams }: {
  ...
  return <div className="project-page">
    <div className="container workspace"><div className="workspace-header"><div><p className="eyebrow">Pair inspection · {project.title}</p><h1>Candidate records</h1><p>Inspect the evidence, then record an explicit equivalence decision.</p></div><Link className="button secondary" href={`/projects/${projectId}/review-flow`}>Review flow →</Link></div>
