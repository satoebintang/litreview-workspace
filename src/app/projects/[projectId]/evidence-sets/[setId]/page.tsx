...
export default async function EvidenceSetDetailPage({
  ...
  return <div className="project-page">
    <div className="container workspace"><div className="workspace-header"><div><p className="eyebrow">Evidence Set</p><h1>{detail.set.name}</h1><p>{detail.set.description ?? "Researcher-defined thematic organization"}</p></div><span className={`status ${active ? "supported" : "stale"}`}>{active ? "● Active" : "Archived · frozen"}</span></div>
