...
export default async function ExtractionPaperPage({ params, searchParams }: {
  ...
  const included = screening.reviewStatus.finalEligibility === "included";
